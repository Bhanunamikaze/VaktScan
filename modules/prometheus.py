...
async def run_scans(ip, port):
    ...
    results.extend(version_cve_results)
    
    # Special handling for Node Exporter on port 9100
    if port == 9100:
        ...
        for ne_result in node_exporter_results:
            ...
            ne_result['server'] = ip
            ne_result['port'] = port
        results.extend(node_exporter_results)
